the folder you're in is root, there are files like ./entry.md and ./progress.txt

FIRST please read ./entry.md to see what this project is all about.
THEN read ./progress.txt, pick the first in progress or unstarted task and work on it.
...
Secrets _only_ go into the secrets.txt file.
